...
use VenosT\AllegroApiClient\Model\AllegroMarketplaces;
...
class InformationAboutMarketplacesApi
{
     ...
     *
     *
     * @return array of \VenosT\AllegroApiClient\Model\AllegroMarketplaces, HTTP status code, HTTP response headers (array of strings)
     *@throws InvalidArgumentException
     * @throws ApiException on non-2xx response
     */
    public function marketplacesGETWithHttpInfo()
    {
        $returnType = '\VenosT\AllegroApiClient\Model\AllegroMarketplaces';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\VenosT\AllegroApiClient\Model\AllegroMarketplaces',
     ...
     * @return Request
     */
    protected function marketplacesGETRequest()
    {
