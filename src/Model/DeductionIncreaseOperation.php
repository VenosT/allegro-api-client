...
class DeductionIncreaseOperation extends BaseOperation 
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelName = 'DeductionIncreaseOperation';
    ...
    protected static $types = [
        'type' => 'string',
        'deduction' => '\VenosT\AllegroApiClient\Model\Deduction'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['type'] = isset($data['type']) ? $data['type'] : 'DEDUCTION_INCREASE';
     ...
     * Sets deduction
     *
     * @param Deduction $deduction deduction
     *
     * @return $this
     */
