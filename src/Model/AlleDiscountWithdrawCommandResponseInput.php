...
/**
 * AlleDiscountWithdrawCommandResponseInput Class Doc Comment
 *
 * @category Class
 * @description Provided withdraw offer command input data.
 * @package  VenosT\AllegroApiClient
 */
class AlleDiscountWithdrawCommandResponseInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelName = 'AlleDiscountWithdrawCommandResponse_input';
     ...
     *
     * @param string $participation_id The id of the participation which will be withdrawn.
     *
     * @return $this
     */
