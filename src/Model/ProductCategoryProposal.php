 ...
 */
class ProductCategoryProposal implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelName = 'ProductCategoryProposal';
     ...
     * Sets current
     *
     * @param string $current Current product category identifier.
     *
     * @return $this
     */
     ...
     * Sets proposal
     *
     * @param string $proposal Proposed product category identifier.
     *
     * @return $this
     */
