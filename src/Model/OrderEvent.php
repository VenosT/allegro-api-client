...
class OrderEvent implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelName = 'OrderEvent';
    ...
    protected static $types = [
        'id' => 'string',
        'order' => '\VenosT\AllegroApiClient\Model\OrderEventData',
        'type' => '\VenosT\AllegroApiClient\Model\OrderEventType',
     ...
     * Sets order
     *
     * @param OrderEventData $order order
     *
     * @return $this
     */
     ...
     * Sets type
     *
     * @param OrderEventType $type type
     *
     * @return $this
     */
