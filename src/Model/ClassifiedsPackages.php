 ...
 */
class ClassifiedsPackages implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelName = 'ClassifiedsPackages';
     ...
     * Sets extra_packages
     *
     * @param ClassifiedExtraPackage[] $extra_packages An array of extra packages.
     *
     * @return $this
     */
