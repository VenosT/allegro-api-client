 ...
 */
class AdditionalServicesGroupRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelName = 'AdditionalServicesGroupRequest';
    ...
    protected static $types = [
        'name' => 'string',
        'language' => 'string',
        'additional_services' => '\VenosT\AllegroApiClient\Model\AdditionalServiceRequest[]'
    ];
     ...
     *
     * @param AdditionalServiceRequest[] $additional_services additional_services
     *
     * @return $this
     */
