...
class OfferBidCanceledEvent extends SellerOfferBaseEvent 
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelName = 'OfferBidCanceledEvent';
    ...
    protected static $types = [
        'type' => 'string',
        'offer' => '\VenosT\AllegroApiClient\Model\OfferEventBaseOffer'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['type'] = isset($data['type']) ? $data['type'] : 'OFFER_BID_CANCELED';
     ...
     * Sets offer
     *
     * @param OfferEventBaseOffer $offer offer
     *
     * @return $this
     */
