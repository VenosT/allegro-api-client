...
class OfferVisibilityChangedEvent extends SellerOfferBaseEvent 
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelName = 'OfferVisibilityChangedEvent';
    ...
    protected static $types = [
        'type' => 'string',
        'offer' => '\VenosT\AllegroApiClient\Model\OfferEventExternalOfferWithPublication'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['type'] = isset($data['type']) ? $data['type'] : 'OFFER_VISIBILITY_CHANGED';
     ...
     * Sets offer
     *
     * @param OfferEventExternalOfferWithPublication $offer offer
     *
     * @return $this
     */
