 ...
 */
class CustomerReturnRefundRejectionRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelName = 'CustomerReturnRefundRejectionRequest';
    ...
    protected static $types = [
        'rejection' => '\VenosT\AllegroApiClient\Model\CustomerReturnRefundRejectionRequestRejection'
    ];
     ...
     * Sets rejection
     *
     * @param CustomerReturnRefundRejectionRequestRejection $rejection rejection
     *
     * @return $this
     */
