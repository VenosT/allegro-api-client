...
/**
 * AlleDiscountGetSubmitCommandResponseOutputNewOfferParticipation Class Doc Comment
 *
 * @category Class
 ...
 */
class AlleDiscountGetSubmitCommandResponseOutputNewOfferParticipation implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelName = 'AlleDiscountGetSubmitCommandResponse_output_newOfferParticipation';
     ...
     *
     * @param string $participation_id The id of the participation created by submit offer command.
     *
     * @return $this
     */
