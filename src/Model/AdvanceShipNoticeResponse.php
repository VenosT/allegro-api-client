 ...
 */
class AdvanceShipNoticeResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelName = 'AdvanceShipNoticeResponse';
     ...
     * Sets submitted_at
     *
     * @param DateTime $submitted_at The date and time of Advance Ship Notice submission. Provided in [ISO 8601 format](link: https://en.wikipedia.org/wiki/ISO_8601).
     *
     * @return $this
     */
