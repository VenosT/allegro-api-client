 ...
 */
class ProductParameter implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelName = 'ProductParameter';
    ...
    protected static $types = [
        ...
        'unit' => 'string',
        'options' => '\VenosT\AllegroApiClient\Model\ProductParameterOptions'
    ];
     ...
     * Sets options
     *
     * @param ProductParameterOptions $options options
     *
     * @return $this
     */
