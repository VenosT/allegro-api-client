...
/**
 * AllOfProductSetElementProduct Class Doc Comment
 *
 * @category Class
 * @description You should enter the product identifier (UUID or EAN) or a complete product definition.
 * @package  VenosT\AllegroApiClient
 */
class AllOfProductSetElementProduct extends ProductOffer 
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelName = 'AllOfProductSetElementProduct';
