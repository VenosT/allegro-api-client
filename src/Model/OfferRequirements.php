 ...
 */
class OfferRequirements implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelName = 'OfferRequirements';
     ...
     * Sets id
     *
     * @param string $id The id of the offer that can be associated with this product.
     *
     * @return $this
     */
