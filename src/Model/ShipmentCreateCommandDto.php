 ...
 */
class ShipmentCreateCommandDto implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelName = 'ShipmentCreateCommandDto';
    ...
    protected static $types = [
        'command_id' => 'string',
        'input' => '\VenosT\AllegroApiClient\Model\ShipmentCreateRequestDto'
    ];
     ...
     * Sets command_id
     *
     * @param string $command_id Command UUID. If empty, then system generate new one.
     *
     * @return $this
     */
     ...
     * Sets input
     *
     * @param ShipmentCreateRequestDto $input input
     *
     * @return $this
     */
