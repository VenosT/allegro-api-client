 ...
 */
class AlleDiscountSubmitCommandRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelName = 'AlleDiscountSubmitCommandRequest';
    ...
    protected static $types = [
        'command_id' => 'string',
        'input' => '\VenosT\AllegroApiClient\Model\AlleDiscountSubmitCommandRequestInput'
    ];
     ...
     * Sets input
     *
     * @param AlleDiscountSubmitCommandRequestInput $input input
     *
     * @return $this
     */
