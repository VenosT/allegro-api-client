...
class PayoutOperationCancel extends BaseOperation 
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelName = 'PayoutOperationCancel';
    ...
    protected static $types = [
        'type' => 'string',
        'payout' => '\VenosT\AllegroApiClient\Model\Payout'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['type'] = isset($data['type']) ? $data['type'] : 'PAYOUT_CANCEL';
