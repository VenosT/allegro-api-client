 ...
 */
class AdditionalServiceGroupTranslationPatchResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelName = 'AdditionalServiceGroupTranslationPatchResponse';
    ...
    protected static $types = [
        'language' => 'string',
        'additional_services' => '\VenosT\AllegroApiClient\Model\AdditionalServicesGroupTranslationWrapperWithType'
    ];
     ...
     *
     * @param AdditionalServicesGroupTranslationWrapperWithType $additional_services additional_services
     *
     * @return $this
     */
