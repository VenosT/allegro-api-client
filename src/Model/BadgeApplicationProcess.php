 ...
 */
class BadgeApplicationProcess implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelName = 'BadgeApplicationProcess';
    ...
    protected static $types = [
        'status' => 'string',
        'rejection_reasons' => '\VenosT\AllegroApiClient\Model\BadgeApplicationRejectionReason[]'
    ];
     ...
     *
     * @return BadgeApplicationRejectionReason[]
     */
     ...
     *
     * @param BadgeApplicationRejectionReason[] $rejection_reasons A list of rejection reasons for the badge application. Returned for process.status = DECLINED only.
     *
     * @return $this
     */
