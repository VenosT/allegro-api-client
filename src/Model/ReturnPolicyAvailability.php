...
class ReturnPolicyAvailability implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelName = 'ReturnPolicyAvailability';
    ...
    protected static $types = [
        'range' => 'string',
        'restriction_cause' => '\VenosT\AllegroApiClient\Model\RestrictionCause'
    ];
     ...
     * Sets range
     *
     * @param string $range Indicates if return policy is full, restricted or disabled.
     *
     * @return $this
     */
     ...
     *
     * @param RestrictionCause $restriction_cause restriction_cause
     *
     * @return $this
     */
