...
class BadgeProcess implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelName = 'BadgeProcess';
     ...
     *
     * @param BadgeApplicationRejectionReason[] $rejection_reasons A list of messages with rejection reasons. Returned for process.status = DECLINED only.
     *
     * @return $this
     */
