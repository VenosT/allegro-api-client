 ...
 */
class FulfillmentOrderParcelItem implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelName = 'FulfillmentOrderParcelItem';
     ...
     * Sets quantity
     *
     * @param int $quantity Number of items placed in a parcel
     *
     * @return $this
     */
     ...
     * Sets serial_numbers
     *
     * @param string[] $serial_numbers List of serial numbers of included items
     *
     * @return $this
     */
     ...
     *
     * @param DateTime $expiration_date Expiration date of all items associated by quantity
     *
     * @return $this
     */
