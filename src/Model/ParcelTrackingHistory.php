 ...
 */
class ParcelTrackingHistory implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelName = 'ParcelTrackingHistory';
    ...
    protected static $types = [
        'waybill' => 'string',
        'tracking_details' => '\VenosT\AllegroApiClient\Model\ParcelTrackingHistoryTrackingDetails'
    ];
     ...
     *
     * @param ParcelTrackingHistoryTrackingDetails $tracking_details tracking_details
     *
     * @return $this
     */
