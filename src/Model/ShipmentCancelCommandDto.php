 ...
 */
class ShipmentCancelCommandDto implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelName = 'ShipmentCancelCommandDto';
    ...
    protected static $types = [
        'command_id' => 'string',
        'input' => '\VenosT\AllegroApiClient\Model\ShipmentCancelRequestDto'
    ];
     ...
     * Sets input
     *
     * @param ShipmentCancelRequestDto $input input
     *
     * @return $this
     */
