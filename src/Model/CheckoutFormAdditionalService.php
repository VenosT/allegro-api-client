...
class CheckoutFormAdditionalService implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelName = 'CheckoutFormAdditionalService';
     ...
     * Sets definition_id
     *
     * @param string $definition_id Additional service id
     *
     * @return $this
     */
     ...
     * Sets name
     *
     * @param string $name Additional service name
     *
     * @return $this
     */
     ...
     * Sets quantity
     *
     * @param int $quantity Quantity of an additional service
     *
     * @return $this
     */
