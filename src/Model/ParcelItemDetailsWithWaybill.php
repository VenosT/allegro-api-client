 ...
 */
class ParcelItemDetailsWithWaybill implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelName = 'ParcelItemDetailsWithWaybill';
    ...
    protected static $types = [
        ...
        'description' => 'string',
        'value' => '\VenosT\AllegroApiClient\Model\ParcelItemDetailsWithWaybillValue',
        'type' => 'string'
    ];
     ...
     * Sets waybill
     *
     * @param string $waybill Parcel waybill.
     *
     * @return $this
     */
     ...
     * Gets value
     *
     * @return ParcelItemDetailsWithWaybillValue
     */
     ...
     * Sets value
     *
     * @param ParcelItemDetailsWithWaybillValue $value value
     *
     * @return $this
     */
