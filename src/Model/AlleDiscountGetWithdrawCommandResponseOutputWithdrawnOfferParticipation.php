...
/**
 * AlleDiscountGetWithdrawCommandResponseOutputWithdrawnOfferParticipation Class Doc Comment
 *
 * @category Class
 * @description Withdrawn offer participation data. Non-null when command status is &#x60;SUCCESSFUL&#x60;.
 * @package  VenosT\AllegroApiClient
 */
class AlleDiscountGetWithdrawCommandResponseOutputWithdrawnOfferParticipation implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelName = 'AlleDiscountGetWithdrawCommandResponse_output_withdrawnOfferParticipation';
     ...
     *
     * @param string $participation_id The id of the withdrawn participation.
     *
     * @return $this
     */
