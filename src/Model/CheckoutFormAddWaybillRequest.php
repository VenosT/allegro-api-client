...
class CheckoutFormAddWaybillRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelName = 'CheckoutFormAddWaybillRequest';
    ...
    protected static $types = [
        ...
        'waybill' => 'string',
        'carrier_name' => 'string',
        'line_items' => '\VenosT\AllegroApiClient\Model\CheckoutFormAddWaybillRequestLineItems[]'
    ];
     ...
     * Sets carrier_name
     *
     * @param string $carrier_name Carrier name to be provided only if carrierId is OTHER, otherwise it’s ignored. Must be no longer than 30 characters.
     *
     * @return $this
     */
     ...
     * Gets line_items
     *
     * @return CheckoutFormAddWaybillRequestLineItems[]
     */
     ...
     * Sets line_items
     *
     * @param CheckoutFormAddWaybillRequestLineItems[] $line_items List of order line items. They must be from the order specified in the path parameter. When list is not provided or it is empty it means that every item from an order is included in shipment.
     *
     * @return $this
     */
