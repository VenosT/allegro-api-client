...
class RequirementChange extends CategoryParametersScheduledBaseChange 
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelName = 'RequirementChange';
    ...
    protected static $types = [
        'type' => 'string',
        'category' => '\VenosT\AllegroApiClient\Model\CategoryParametersScheduledBaseChangeCategory',
        'parameter' => '\VenosT\AllegroApiClient\Model\CategoryParametersScheduledBaseChangeParameter'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['type'] = isset($data['type']) ? $data['type'] : 'REQUIREMENT_CHANGE';
     ...
     * Sets category
     *
     * @param CategoryParametersScheduledBaseChangeCategory $category category
     *
     * @return $this
     */
     ...
     * Sets parameter
     *
     * @param CategoryParametersScheduledBaseChangeParameter $parameter parameter
     *
     * @return $this
     */
