...
class OfferPriceChangedEvent extends SellerOfferBaseEvent 
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelName = 'OfferPriceChangedEvent';
    ...
    protected static $types = [
        'type' => 'string',
        'offer' => '\VenosT\AllegroApiClient\Model\OfferEventExternalOfferForPriceChanges'
    ];
     ...
     * Sets offer
     *
     * @param OfferEventExternalOfferForPriceChanges $offer offer
     *
     * @return $this
     */
