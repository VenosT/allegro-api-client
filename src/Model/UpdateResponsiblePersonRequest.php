 ...
 */
class UpdateResponsiblePersonRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelName = 'UpdateResponsiblePersonRequest';
    ...
    protected static $types = [
        'id' => 'string',
        'name' => 'string',
        'personal_data' => '\VenosT\AllegroApiClient\Model\CreateResponsiblePersonRequestPersonalData'
    ];
     ...
     * Sets name
     *
     * @param string $name Internal name of responsible person in dictionary.
     *
     * @return $this
     */
     ...
     * Sets personal_data
     *
     * @param CreateResponsiblePersonRequestPersonalData $personal_data personal_data
     *
     * @return $this
     */
