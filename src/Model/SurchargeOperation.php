...
class SurchargeOperation extends BaseOperation 
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelName = 'SurchargeOperation';
    ...
    protected static $types = [
        'type' => 'string',
        'payment' => '\VenosT\AllegroApiClient\Model\OperationPayment',
        'surcharge' => '\VenosT\AllegroApiClient\Model\Surcharge',
        'participant' => '\VenosT\AllegroApiClient\Model\BuyerParticipant'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['type'] = isset($data['type']) ? $data['type'] : 'SURCHARGE';
     ...
     * Sets payment
     *
     * @param OperationPayment $payment payment
     *
     * @return $this
     */
     ...
     * Sets surcharge
     *
     * @param Surcharge $surcharge surcharge
     *
     * @return $this
     */
     ...
     * Sets participant
     *
     * @param BuyerParticipant $participant participant
     *
     * @return $this
     */
