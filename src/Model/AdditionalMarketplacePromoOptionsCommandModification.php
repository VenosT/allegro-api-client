 ...
 */
class AdditionalMarketplacePromoOptionsCommandModification implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelName = 'AdditionalMarketplacePromoOptionsCommandModification';
