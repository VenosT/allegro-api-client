 ...
 */
class SenderAddressDto extends AddressDto 
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelName = 'SenderAddressDto';
     ...
     * Sets point
     *
     * @param string $point Drop off point id. You can get it directly from courier service.
     *
     * @return $this
     */
