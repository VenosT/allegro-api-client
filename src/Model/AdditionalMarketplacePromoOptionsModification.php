 ...
 */
class AdditionalMarketplacePromoOptionsModification implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelName = 'AdditionalMarketplacePromoOptionsModification';
     ...
     * Sets modifications
     *
     * @param PromoOptionsModification[] $modifications Promo package modifications to be applied on additional marketplace.
     *
     * @return $this
     */
