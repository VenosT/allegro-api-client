...
class CompatibilityListManualType implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelName = 'CompatibilityListManualType';
    ...
    protected static $types = [
        'items' => '\VenosT\AllegroApiClient\Model\CompatibilityListItem[]'
    ];
