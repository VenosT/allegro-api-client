 ...
 */
class ShippingRateMaxPackageWeight implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelName = 'ShippingRate_maxPackageWeight';
     ...
     * Sets value
     *
     * @param string $value Weight value with an accuracy of three decimal places.
     *
     * @return $this
     */
