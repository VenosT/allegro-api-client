 ...
 */
class AvailableProductResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelName = 'AvailableProductResponse';
     ...
     * Sets gtins
     *
     * @param string[] $gtins List of product's GTIN numbers.
     *
     * @return $this
     */
