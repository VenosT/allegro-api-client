...
/**
 * AlleDiscountGetWithdrawCommandResponseInput Class Doc Comment
 *
 * @category Class
 * @description Provided withdraw offer command input data.
 * @package  VenosT\AllegroApiClient
 */
class AlleDiscountGetWithdrawCommandResponseInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelName = 'AlleDiscountGetWithdrawCommandResponse_input';
