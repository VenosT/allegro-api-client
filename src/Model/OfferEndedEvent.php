...
class OfferEndedEvent extends SellerOfferBaseEvent 
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelName = 'OfferEndedEvent';
    ...
    protected static $types = [
        'type' => 'string',
        'offer' => '\VenosT\AllegroApiClient\Model\OfferEventEndedOffer'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['type'] = isset($data['type']) ? $data['type'] : 'OFFER_ENDED';
     ...
     * Sets offer
     *
     * @param OfferEventEndedOffer $offer offer
     *
     * @return $this
     */
