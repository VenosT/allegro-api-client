...
class Participant implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelName = 'Participant';
    ...
    protected static $types = [
        ...
        'first_name' => 'string',
        'last_name' => 'string',
        'address' => '\VenosT\AllegroApiClient\Model\OperationParticipantAddress'
    ];
     ...
     * Sets address
     *
     * @param OperationParticipantAddress $address address
     *
     * @return $this
     */
