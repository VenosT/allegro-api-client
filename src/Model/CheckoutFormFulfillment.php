 ...
 */
class CheckoutFormFulfillment implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelName = 'CheckoutFormFulfillment';
    ...
    protected static $types = [
        'status' => '\VenosT\AllegroApiClient\Model\CheckoutFormFulfillmentStatus',
        'shipment_summary' => '\VenosT\AllegroApiClient\Model\CheckoutFormFulfillmentShipmentSummary'
    ];
     ...
     * Gets status
     *
     * @return CheckoutFormFulfillmentStatus
     */
     ...
     * Sets status
     *
     * @param CheckoutFormFulfillmentStatus $status status
     *
     * @return $this
     */
     ...
     *
     * @param CheckoutFormFulfillmentShipmentSummary $shipment_summary shipment_summary
     *
     * @return $this
     */
