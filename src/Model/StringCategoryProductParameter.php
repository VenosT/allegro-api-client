...
class StringCategoryProductParameter extends CategoryProductParameter 
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelName = 'StringCategoryProductParameter';
    ...
    protected static $types = [
        'type' => 'string',
        'restrictions' => '\VenosT\AllegroApiClient\Model\StringCategoryProductParameterRestrictions'
    ];
     ...
     * Sets restrictions
     *
     * @param StringCategoryProductParameterRestrictions $restrictions restrictions
     *
     * @return $this
     */
