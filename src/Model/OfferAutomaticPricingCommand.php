 ...
 */
class OfferAutomaticPricingCommand implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelName = 'OfferAutomaticPricingCommand';
    ...
    protected static $types = [
        'id' => 'string',
        'modification' => 'OneOfOfferAutomaticPricingCommandModification',
     ...
     * Sets id
     *
     * @param string $id The Command identifier. This field is optional. If the client does not provide their own command id then the service will generate a command id and return it in the response.
     *
     * @return $this
     */
     ...
     * Gets modification
     *
     * @return OneOfOfferAutomaticPricingCommandModification
     */
     ...
     * Sets modification
     *
     * @param OneOfOfferAutomaticPricingCommandModification $modification modification
     *
     * @return $this
     */
