...
class PublicationModification implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelName = 'Publication_modification';
     ...
     * Sets scheduled_for
     *
     * @param DateTime $scheduled_for Date and time for scheduling ACTIVATE action, will be ignored for another actions
     *
     * @return $this
     */
