 ...
 */
class SmartSellerClassificationReportConditions implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelName = 'SmartSellerClassificationReport_conditions';
     ...
     * Sets value
     *
     * @param float $value Value of related user attribute that this condition tests. Has to be greater that threshold if present.
     *
     * @return $this
     */
     ...
     * Sets threshold
     *
     * @param float $threshold Minimum required `value` of related user attribute.
     *
     * @return $this
     */
     ...
     * Sets required
     *
     * @param bool $required Indicates whether this condition is required to obtain Smart! status. Please note that certain conditions may be required (or not) based on result of checking other conditions.
     *
     * @return $this
     */
