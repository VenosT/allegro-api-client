 ...
 */
class ProductParameterValueProposal implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelName = 'ProductParameterValueProposal';
     ...
     * Sets current
     *
     * @param string $current Current product parameter value.
     *
     * @return $this
     */
     ...
     * Sets proposal
     *
     * @param string $proposal Proposed product parameter value.
     *
     * @return $this
     */
