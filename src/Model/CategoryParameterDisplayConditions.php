 ...
 */
class CategoryParameterDisplayConditions implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelName = 'CategoryParameterDisplayConditions';
     ...
     *
     * @param CategoryParameterWithValue[] $parameters_with_value Condition type which displays this parameter only if each of the given other parameters has filled in one of the respective given value ids in an offer or product. Empty if no condition of this type is present.
     *
     * @return $this
     */
