...
class FulfillmentOrder implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelName = 'FulfillmentOrder';
    ...
    protected static $types = [
        'order_id' => 'string',
        'parcels' => '\VenosT\AllegroApiClient\Model\FulfillmentOrderParcel[]'
    ];
     ...
     * Sets parcels
     *
     * @param FulfillmentOrderParcel[] $parcels parcels
     *
     * @return $this
     */
