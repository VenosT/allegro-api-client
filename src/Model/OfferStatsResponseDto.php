 ...
 */
class OfferStatsResponseDto implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelName = 'OfferStatsResponseDto';
    ...
    protected static $types = [
        'offer_stats' => '\VenosT\AllegroApiClient\Model\OfferStatResponseDto[]'
    ];
    ...
    {
        $this->container['offer_stats'] = isset($data['offer_stats']) ? $data['offer_stats'] : null;
    }
     ...
     * Sets offer_stats
     *
     * @param OfferStatResponseDto[] $offer_stats offer_stats
     *
     * @return $this
     */
