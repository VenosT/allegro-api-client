 ...
 */
class MarketplacesVisibility implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelName = 'MarketplacesVisibility';
    ...
    protected static $types = [
        'base' => 'string',
        'additional' => '\VenosT\AllegroApiClient\Model\AdditionalMarketplacesVisibility[]'
    ];
     ...
     * Gets additional
     *
     * @return AdditionalMarketplacesVisibility[]
     */
     ...
     * Sets additional
     *
     * @param AdditionalMarketplacesVisibility[] $additional Additional marketplaces information.
     *
     * @return $this
     */
