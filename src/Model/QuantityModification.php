...
class QuantityModification implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelName = 'QuantityModification';
     ...
     * Sets change_type
     *
     * @param string $change_type modification type
     *
     * @return $this
     */
     ...
     * Sets value
     *
     * @param int $value - For changeType = \"FIXED\", a new stock quantity > 0 - For changeType = \"GAIN\", an increase/decrease in stock quantity
     *
     * @return $this
     */
