 ...
 */
class PickupCreateCommandDto implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelName = 'PickupCreateCommandDto';
    ...
    protected static $types = [
        'command_id' => 'string',
        'input' => '\VenosT\AllegroApiClient\Model\PickupCreateRequestDto'
    ];
     ...
     * Sets input
     *
     * @param PickupCreateRequestDto $input input
     *
     * @return $this
     */
