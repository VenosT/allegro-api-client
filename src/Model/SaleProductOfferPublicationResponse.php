 ...
 */
class SaleProductOfferPublicationResponse extends Publication 
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelName = 'SaleProductOfferPublicationResponse';
    ...
    protected static $types = [
        'marketplaces' => '\VenosT\AllegroApiClient\Model\SaleProductOfferPublicationMarketplacesResponse'
    ];
     ...
     * Sets marketplaces
     *
     * @param SaleProductOfferPublicationMarketplacesResponse $marketplaces marketplaces
     *
     * @return $this
     */
