...
class VariantSets implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelName = 'VariantSets';
    ...
    protected static $types = [
        'count' => 'int',
        'offer_variants' => '\VenosT\AllegroApiClient\Model\VariantSetsVariantSet[]'
    ];
     ...
     * Sets count
     *
     * @param int $count Total number of variant sets matching the query.
     *
     * @return $this
     */
     ...
     * Sets offer_variants
     *
     * @param VariantSetsVariantSet[] $offer_variants offer_variants
     *
     * @return $this
     */
