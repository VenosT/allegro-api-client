...
/**
 * ReturnPoliciesListReturnPolicyBasic_ Class Doc Comment
 */
class ReturnPoliciesListReturnPolicyBasic_ implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelName = 'ReturnPoliciesList_ReturnPolicyBasic_';
    ...
    protected static $types = [
        'count' => 'int',
        'return_policies' => '\VenosT\AllegroApiClient\Model\ReturnPolicyBasic[]'
    ];
     ...
     *
     * @param ReturnPolicyBasic[] $return_policies return_policies
     *
     * @return $this
     */
