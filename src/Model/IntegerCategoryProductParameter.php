...
class IntegerCategoryProductParameter extends CategoryProductParameter 
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelName = 'IntegerCategoryProductParameter';
    ...
    protected static $types = [
        'type' => 'string',
        'restrictions' => '\VenosT\AllegroApiClient\Model\IntegerCategoryProductParameterRestrictions'
    ];
     ...
     * Sets restrictions
     *
     * @param IntegerCategoryProductParameterRestrictions $restrictions restrictions
     *
     * @return $this
     */
