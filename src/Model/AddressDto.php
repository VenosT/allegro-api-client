...
class AddressDto implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelName = 'AddressDto';
     ...
     * Sets name
     *
     * @param string $name Person name. Name or Company are required.
     *
     * @return $this
     */
     ...
     * Sets company
     *
     * @param string $company Company name. Name or Company are required.
     *
     * @return $this
     */
     ...
     * Sets state
     *
     * @param string $state Required for shipments to Ireland( county name ), United States ( state abbreviation / ISO code ), Canada ( province postal code / ISO code )
     *
     * @return $this
     */
     ...
     * Sets point
     *
     * @param string $point Pickup point id. You can get it from order or directly from courier service.
     *
     * @return $this
     */
