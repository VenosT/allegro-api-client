 ...
 */
class ParcelDetailsLabel implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelName = 'ParcelDetails_label';
     ...
     *
     * @param string $reference_number Parcel identifier in own system. Example: `Ordering number`.
     *
     * @return $this
     */
