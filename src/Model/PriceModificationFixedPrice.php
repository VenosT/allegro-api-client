...
class PriceModificationFixedPrice extends PriceModification 
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelName = 'PriceModificationFixedPrice';
    ...
    protected static $types = [
        'type' => 'string',
        'price' => '\VenosT\AllegroApiClient\Model\PriceModificationFixedPriceHolder'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['type'] = isset($data['type']) ? $data['type'] : 'FIXED_PRICE';
     ...
     * Sets price
     *
     * @param PriceModificationFixedPriceHolder $price price
     *
     * @return $this
     */
