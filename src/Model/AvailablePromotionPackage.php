 ...
 */
class AvailablePromotionPackage implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelName = 'AvailablePromotionPackage';
     ...
     * Sets id
     *
     * @param string $id Promotion package identifier.
     *
     * @return $this
     */
     ...
     * Sets name
     *
     * @param string $name Promotion package name.
     *
     * @return $this
     */
     ...
     * Sets cycle_duration
     *
     * @param string $cycle_duration Promo package cycle duration.
     *
     * @return $this
     */
