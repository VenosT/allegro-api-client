 ...
 */
class AdditionalMarketplacesVisibility implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelName = 'AdditionalMarketplacesVisibility';
    ...
    protected static $types = [
        'id' => 'string',
        'status' => 'string',
        'refusal_reasons' => '\VenosT\AllegroApiClient\Model\RefusalReason[]'
    ];
     ...
     *
     * @param RefusalReason[] $refusal_reasons Reasons of visibility refusal.
     *
     * @return $this
     */
