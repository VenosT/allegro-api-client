 ...
 */
class BadgeApplicationPurchaseConstraintsLimitPerUser implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelName = 'BadgeApplicationPurchaseConstraintsLimitPerUser';
     ...
     * Sets max_items
     *
     * @param int $max_items Maximum number of items that one user can buy of this offer, while it participates in the campaign.
     *
     * @return $this
     */
